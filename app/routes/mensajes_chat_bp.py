...
mensajes_chat_bp('/chat', methods=['GET'])(Mensaje.get_all)
#mensajes_chat('/<int:<id_mensajes_chat>', methods=['GET'])(Mensaje.get)
mensajes_chat_bp('/chat', methods=['POST'])(Mensaje.create)
#mensajes_chat('/<id_mensajes_chat>', methods=['PUT'])(Mensaje.update)
mensajes_chat_bp('/chat<int:<id_mensajes_chat>', methods=['DELETE'])(Mensaje.delete)